%% WAD_get_firstlvl_dsgn_obj_model_1
%
...
%
%__________________________________________________________________________
% @(#)% WAD_get_firstlvl_dsgn_obj_model_1.m         v1.0       
% last modified: 2021/04/08
%
%
%% function code
function DSGN = WAD_get_firstlvl_dsgn_obj_model_1()
    % INPUT
    % required fields
    DSGN.metadata = "WAD first level analysis model 1, i.e. modeling 3 conditions for high, moderate, neutral fear as 6 second events (= duration of picture + imagine)"; % field for annotation with study info, or whatever you like
    DSGN.modeldir = 'C:\Users\lukas\Dropbox (Dartmouth College)\4.Iris_WAD_MRI\firstlevel\model_1_pictures'; % directory where you want to write first level results
...
%     DSGN.singletrialsall = false; % default: false; if true, set DSGN.singletrials to true for all conditions
    DSGN.modelingfilesdir = 'model_1_pictures'; % name of subfolder which will be created within directory containing functional files where .mat files containing fields of DSGN structure will be saved
