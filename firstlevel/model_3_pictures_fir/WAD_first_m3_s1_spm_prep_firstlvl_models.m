%% WAD_first_m3_s1_spm_prep_firstlvl_models
%
...
%
%__________________________________________________________________________
% @(#)% WAD_first_m3_s1_spm_prep_firstlvl_models.m         v1.0        
...
%                 positive.orth = {[0]}; 
            ...
            maxDesignTiming = max([high_fear.onset{1} + high_fear.duration{1}, moderate_fear.onset{1} + moderate_fear.duration{1}, neutral_fear.onset{1} + neutral_fear.duration{1}]);
