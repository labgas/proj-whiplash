%% WAD_second_m2_copy_con_imgs_CANlab_folder_struct
%
...
% date:   April, 2021
%__________________________________________________________________________
% @(#)% WAD_second_m2_copy_con_imgs_CANlab_folder_struct     v1.0        
% last modified: 2021/04/13


%% DEFINE MODEL AND DIRECTORIES
%--------------------------------------------------------------------------
conimgs2copy=[1:3,8:10,15:17]; % numbers of con images to copy
