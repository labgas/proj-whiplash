...
basedir = 'C:\Users\lukas\Dropbox (Dartmouth College)\4.Iris_WAD_MRI\secondlevel\model_1_pictures';

% Set user options
% --------------------------------------------------------

a2_WAD_second_m1_s2_set_default_options % lukasvo76: referring to renamed study- and model-specific script here, as I want to customize the default option - see my note in documentation above
...
scriptsdir = 'C:\Users\lukas\Dropbox (Dartmouth College)\4.Iris_WAD_MRI\scripts_windows\secondlevel\model_1_pictures'; % lukasvo76: contrary to CANlab structure, we have a separate scripts dir under the project rootdir
