...
DAT.conditions = {'high_fear' 'moderate_fear' 'neutral_fear'};
...
DAT.contrasts = [1 0 -1; 0 1 -1; 1 -1 0; 0.5 0.5 -1];
    
% Descriptive names for contrasts to be used in plots and tables. Avoid
% special characters.
DAT.contrastnames = {'high fear v neutral' 'moderate fear v neutral' 'high fear v moderate fear' '(high + moderate) fear v neutral'};
